...
The [issue tracker](https://github.com/ujjawal-shrivastava/confess/issues) is
...
Since the `master` branch is what people actually use in production, only when we
...
1.  [Fork](https://help.github.com/articles/fork-a-repo/) the project, clone your fork, and configure the remotes:
    ...
    git remote add upstream https://github.com/ujjawal-shrivastava/confess.git
    ```
